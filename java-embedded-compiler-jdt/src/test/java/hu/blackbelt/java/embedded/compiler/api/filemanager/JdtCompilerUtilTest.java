...
import hu.blackbelt.java.embedded.compiler.jdt.JdtCompilerFactory;
...
public class JdtCompilerUtilTest {
    ...
    public void setup() throws MalformedURLException, ClassNotFoundException {
        ...
        ClassLoader classLoader = new URLClassLoader(urlsForClassLoader, JdtCompilerUtilTest.class.getClassLoader());
        Thread.currentThread().setContextClassLoader(classLoader);
        classLoader.loadClass("javax.ws.rs.Path");
        compilerFactory = new JdtCompilerFactory();
    }
    ...
    public void testFactoryServiceLoader() {
        ...
        assertThat(compilerFactory.getClass(), equalTo(JdtCompilerFactory.class));
    }
