...
public class ForwardingStandardJavaFileManager
     ...
     */
    protected ForwardingStandardJavaFileManager(StandardJavaFileManager fileManager, ClassLoader classLoader) {
        super(fileManager);
    ...
    public ClassLoader getClassLoader(Location location) {
        return ofNullable(classLoader).orElse(super.getClassLoader(location));
    }
